...
.btn{background:#151514;border-color:#151514;border-radius:6px;box-shadow:none}
.btn:hover{transform:none;background:#292925;border-color:#292925;box-shadow:0 8px 18px rgba(22,25,25,.12)}
...
.contact-action{position:relative;z-index:3;display:block;align-self:center;padding-top:0}
.contact-action .btn{width:100%;min-width:0;min-height:58px;margin:0!important}
.contact-links{display:grid;gap:12px;margin-top:20px;font-size:15px;line-height:1.5}
...
@media (max-width:980px){
  ...
  .contact-layout{grid-template-columns:1fr 1fr;gap:40px;padding-top:120px}.contact-copy{grid-column:1/-1}.contact-action{display:block;align-self:start;padding-top:0}.contact-artwork{min-height:390px}.contact-art{right:-20%;width:125%}.contact-monogram{left:40%;top:12%}
}
...
@media (max-width:680px){
  ...
  .contact-layout{grid-template-columns:1fr;gap:34px;padding:105px 0 35px}.contact-copy{grid-column:auto}.contact-action{display:block;padding-top:0}.contact-action .btn{width:100%}.contact-artwork{min-height:340px}.contact-art{right:-34%;bottom:-8%;width:150%}.contact-monogram{left:38%;top:8%;width:72px;height:150px}
}

/* Final proportion, readability, and rhythm polish */
.beautimax-root{--blue:#2458b8}
.section{padding:clamp(82px,6.3vw,110px) 0}
.market-section{padding:0}
.card-copy{font-size:clamp(16px,1.08vw,19px);line-height:1.58}
.btn{background:var(--blue);border-color:var(--blue);border-radius:7px;box-shadow:0 8px 20px rgba(36,88,184,.16)}
.btn:hover{transform:translateY(-1px);background:#1d4b9d;border-color:#1d4b9d;box-shadow:0 11px 24px rgba(36,88,184,.2)}

.hero{min-height:clamp(720px,88svh,890px);padding:116px max(7.55vw,calc((100vw - 1680px)/2 + 145px)) 64px}
.hero-copy{max-width:51%;padding-top:0}
.h1{max-width:760px;margin-bottom:32px;font-size:clamp(54px,4.6vw,76px);line-height:.96;letter-spacing:-.062em}
.lead{max-width:610px;margin-bottom:32px;font-size:clamp(18px,1.22vw,21px);line-height:1.58}
.hero-art{top:11%;right:0;bottom:-3%;width:59%}
.hero-visual{width:100%}

.whatsapp-float{border-color:rgba(255,255,255,.38);background:#209b59;color:#fff;box-shadow:0 12px 30px rgba(14,92,49,.25),inset 0 1px 0 rgba(255,255,255,.22);backdrop-filter:none;-webkit-backdrop-filter:none}
.whatsapp-float:hover{background:#178149;box-shadow:0 15px 34px rgba(14,92,49,.3),inset 0 1px 0 rgba(255,255,255,.2)}
.whatsapp-float svg{fill:#fff}
.whatsapp-status{background:#b9f2cf;border-color:#209b59}

.market-stage{height:clamp(760px,90svh,900px);min-height:0;overflow:visible}
.market-map{position:absolute;inset:0;width:100%;height:100%;min-height:0;object-fit:contain;object-position:center;transform:translate3d(0,var(--market-parallax),0)}
.market-map-mobile{display:none}
.market-overlay{min-height:100%}
.market-overlay{padding:clamp(58px,6vh,76px) 0 34px}
.market-title{max-width:1120px}
.stats{background:rgba(244,241,233,.88)}
.stat,.stat-1,.stat-2,.stat-3,.stat-4{display:flex;min-height:184px;padding:20px;flex-direction:column;justify-content:center}
.stat-value{font-size:clamp(46px,3.8vw,68px)}
.stat-label{font-size:clamp(13px,.92vw,15px)}

#about{padding-block:clamp(96px,7vw,124px)}
.about-layout{grid-template-columns:minmax(390px,.86fr) minmax(520px,1.14fr);gap:clamp(94px,8vw,144px)}
.about-copy .section-title{margin-bottom:38px}
.about-copy p.about-intro{max-width:610px;margin:0;font-size:clamp(17px,1.12vw,19px);line-height:1.72}
.about-copy p.about-audience{max-width:610px;margin:32px 0 0;font-size:clamp(17px,1.16vw,20px);font-weight:700;line-height:1.62}
.pillars{padding:14px 0}
.pillar{grid-template-columns:62px minmax(0,1fr);min-height:148px;padding:27px 16px;gap:22px;align-items:center}
.pillar .line-icon{width:56px;height:56px}
.pillar-copy .card-title{margin-bottom:12px;font-size:17px}
.pillar-copy .card-copy{font-size:17px;line-height:1.6}

.capabilities-section{padding-block:clamp(88px,6.5vw,112px)}
.cap-grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:28px;margin-top:68px}
.capability{min-height:0;padding:18px 0 28px}
.cap-image{height:265px;margin:16px 0 22px}
.cap-image img{width:106%;height:106%}
.cap-copy{grid-template-columns:38px minmax(0,1fr);gap:8px}
.capability .eyebrow{font-size:20px}
.capability .card-title{margin-bottom:17px;font-size:clamp(18px,1.3vw,23px);line-height:1.08}
.capability .card-copy{font-size:16.5px;line-height:1.54}

.network-header{display:block}
.network-header .card-copy{max-width:780px!important;margin:26px 0 0!important;font-size:18px;line-height:1.62}
.network-visual{margin-top:64px}
.network-proof{padding:32px 0 34px}
.network-stat{margin:18px 0 20px}
.network-label{font-size:clamp(18px,1.25vw,23px)}

#brands{padding-block:clamp(94px,7vw,122px)}
.brands-layout{gap:clamp(72px,6vw,108px)}
.brands-copy .section-title{max-width:360px;font-size:clamp(40px,3.05vw,54px);line-height:.98}
.brands-copy .card-copy{font-size:17px;line-height:1.62}
.brands-copy .card-copy{margin-top:30px}
.brand-stage{padding:24px 220px 34px 0;background:transparent;border:0}
.slides{gap:16px}
.slide{border-color:rgba(16,16,15,.18);box-shadow:0 8px 22px rgba(35,35,31,.05)}
.slide:hover{box-shadow:0 14px 30px rgba(35,35,31,.1)}
.icon-btn{background:rgba(16,16,15,.08);border:1px solid rgba(16,16,15,.16);color:#10100f}
.dot{border-color:rgba(16,16,15,.42)}
.dot.active{background:#315f75}
.carousel-meta{justify-content:flex-start;margin-top:20px;padding:0}
.phone-frame{right:-18px;bottom:-38px;width:280px;filter:drop-shadow(0 20px 30px rgba(0,0,0,.17))}

.partnerships{margin-top:58px}
.partnership-card,.partnership-card:nth-child(2),.partnership-card:nth-child(3){min-height:350px;padding:34px 32px}
.partnership-card .line-icon{width:78px;height:78px;margin:22px 0 29px}
.partnership-card .card-title{margin-bottom:17px;line-height:1.08}
.partnership-card .card-copy{font-size:17px;line-height:1.6}

.contact-section{padding:0}
.contact-layout{grid-template-columns:minmax(470px,.94fr) minmax(520px,1.06fr);min-height:680px;padding:70px 0 30px;gap:clamp(72px,7vw,124px);align-items:center}
.contact-copy .section-title{max-width:640px;font-size:clamp(54px,4.7vw,82px);line-height:.92}
.contact-subcopy{max-width:500px;margin-top:28px;font-size:17px;line-height:1.64}
.contact-cta{width:auto;min-height:58px;margin-top:36px!important;padding-inline:38px}
.contact-artwork{align-self:stretch;min-height:540px;display:flex;align-items:center;justify-content:center}
.contact-art{left:50%;right:auto;top:50%;bottom:auto;width:118%;transform:translate(-50%,-47%)}
.contact-monogram{left:50%;top:50%;width:116px;height:240px;transform:translate(-50%,-53%)}

@media (max-width:1280px){
  .hero{padding-inline:6vw}.hero-copy{max-width:53%}.hero-art{top:12%;right:-2%;width:61%}
  .cap-grid{gap:18px}.cap-image{height:230px}.capability .card-title{font-size:18px}.capability .card-copy{font-size:16px}
  .brands-layout{gap:58px}.brand-stage{padding-right:195px}.phone-frame{width:250px}
  .contact-layout{grid-template-columns:minmax(410px,.95fr) minmax(440px,1.05fr);gap:52px}.contact-art{width:128%}
}

@media (max-width:980px){
  .section{padding:86px 0}
  .hero{min-height:900px;padding:118px 6vw 58px;align-items:flex-start}.hero-copy{max-width:79%}.h1{font-size:clamp(54px,7.8vw,70px)}.hero-art{top:39%;right:-10%;bottom:-5%;width:74%}
  .market-stage{height:870px}.market-map{height:100%;object-fit:contain}.market-overlay{min-height:100%;padding:66px 0 28px}
  .about-layout{gap:66px}.about-copy .section-title{margin-bottom:32px}.pillars{grid-template-columns:1fr 1fr;padding:0}.pillar{min-height:158px;padding:24px 16px}
  .cap-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:44px 30px}.capability{min-height:0}.cap-image{height:310px}
  .network-header .card-copy{margin-top:22px!important}.network-visual{margin-top:48px}
  #about{padding-block:92px}.brands-layout{gap:52px}.brand-stage{padding:22px 190px 30px 0;background:transparent}.phone-frame{width:235px}
  .partnership-card,.partnership-card:nth-child(2),.partnership-card:nth-child(3){min-height:320px;padding:26px 22px}.partnership-card .line-icon{margin:18px 0 26px}
  .contact-layout{grid-template-columns:minmax(0,1.04fr) minmax(300px,.96fr);gap:38px;padding:82px 0 32px}.contact-copy{grid-column:auto}.contact-copy .section-title{font-size:clamp(48px,7.2vw,66px)}.contact-cta{margin-top:30px!important}.contact-artwork{min-height:450px}.contact-art{width:132%}.contact-monogram{width:92px;height:195px}
}

@media (max-width:680px){
  .section{padding:78px 0}.card-copy{font-size:16px}
  .hero{min-height:830px;padding:104px 22px 46px}.hero-copy{max-width:100%}.h1{font-size:clamp(42px,11.5vw,51px);line-height:.97}.lead{font-size:17px;line-height:1.52}.hero-art{top:56%;right:-12%;bottom:-3%;width:112%}
  .market-stage{height:980px}.market-overlay{min-height:100%;padding:62px 0 22px}.market-map{top:220px;left:0;width:100%;height:390px;object-fit:contain;transform:none}.stat,.stat-1,.stat-2,.stat-3,.stat-4{min-height:155px;padding:16px 10px}.stat-value{font-size:36px}.stat-label{font-size:10px}
  #about{padding-block:82px}.about-layout{gap:50px}.about-copy .section-title{margin-bottom:28px}.about-copy p.about-intro{font-size:16px;line-height:1.7}.about-copy p.about-audience{margin-top:26px;font-size:17px;line-height:1.62}.pillar{grid-template-columns:50px 1fr;min-height:136px;padding:22px 0;gap:16px}.pillar .line-icon{width:46px;height:46px}.pillar-copy .card-title{font-size:15px}.pillar-copy .card-copy{font-size:15px}
  .capabilities-section{padding-block:78px}.cap-grid{grid-template-columns:1fr;gap:54px;margin-top:46px}.capability{min-height:0}.cap-image{height:270px}.capability .card-copy{font-size:16px}
  .network-header .card-copy{font-size:16px}.network-visual{margin-top:42px}.network-art-frame{width:148%;margin-left:-24%}.network-art{margin-top:-3%}
  #brands{padding-block:82px}.brands-layout{gap:38px}.brands-copy .section-title{max-width:330px;font-size:40px}.brands-copy .card-copy{margin-top:24px;font-size:16px}.brand-stage{padding:16px 0 22px;background:transparent}.slides{padding-right:18px}.phone-frame{width:74%;margin:-30px -2% 0 auto}.carousel-meta{display:none}
  .partnerships{margin-top:44px}.partnership-card,.partnership-card:nth-child(2),.partnership-card:nth-child(3){min-height:0;padding:26px}.partnership-card .line-icon{margin:18px 0 26px}.partnership-card .card-copy{font-size:16px}
  .contact-layout{grid-template-columns:1fr;gap:34px;padding:78px 0 28px}.contact-copy{grid-column:auto}.contact-copy .section-title{font-size:clamp(43px,12.5vw,58px)}.contact-subcopy{margin-top:24px;font-size:16px}.contact-cta{width:100%;margin-top:28px!important}.contact-artwork{min-height:350px}.contact-art{width:140%}.contact-monogram{width:78px;height:164px}
}

/* Dedicated mobile recomposition — desktop and tablet rules above remain unchanged. */
@media (max-width:680px){
  html,body{min-width:0;overflow-x:clip}
  html{scroll-padding-top:68px}
  .beautimax-root{overflow-x:clip}
  .beautimax-shell{width:100%;padding-inline:22px}
  .section{min-height:0;padding:74px 0}
  .section-title,.market-title,.network-title{font-size:clamp(32px,9.2vw,38px);line-height:1;letter-spacing:-.05em;text-wrap:balance}
  .card-copy{font-size:15.5px;line-height:1.62}
  .btn{width:auto;min-width:0;min-height:50px;padding:12px 18px;gap:24px;font-size:13px}

  .nav{padding-top:7px}
  .nav .beautimax-shell{padding-inline:12px}
  .nav-inner,.nav.is-compact .nav-inner{height:58px;padding-inline:14px;gap:10px;border-radius:12px}
  ...
  .hero-section{padding-inline:22px}
  .hero{display:flex;min-height:0;padding:92px 0 16px;flex-direction:column;align-items:stretch}
  .hero::after{display:none}
  .hero-copy{order:1;max-width:none;padding:0}
  .h1{max-width:100%;margin-bottom:22px;font-size:clamp(36px,10.4vw,40px);line-height:1.01;letter-spacing:-.055em}
  .lead{max-width:100%;margin-bottom:24px;font-size:16px;line-height:1.58}
  .hero-actions{display:flex;justify-content:flex-start}
  .hero-actions .btn{width:auto;min-width:210px}
  .hero-art{position:relative;order:2;inset:auto;width:100%;height:auto;margin:14px 0 0;transform:none;will-change:auto}
  .hero-visual{width:100%;max-width:100%;height:auto;object-fit:contain}

  .market-section{padding:70px 0 72px}
  .market-stage{display:block;height:auto;min-height:0;overflow:visible}
  .market-stage>.market-map{display:none}
  .market-overlay{position:relative;display:flex;min-height:0;padding:0;flex-direction:column}
  .market-title{order:0;margin:0 0 22px;font-size:clamp(32px,9.2vw,36px)}
  .market-map-mobile{display:block;order:1;width:calc(100% + 44px);max-width:none;height:auto;margin:0 -22px;object-fit:contain;object-position:center}
  .stats{position:relative;order:2;inset:auto;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));margin:12px 0 0;padding:0;border-top:1px solid rgba(16,16,15,.2);background:transparent;backdrop-filter:none;-webkit-backdrop-filter:none}
  .stat,.stat-1,.stat-2,.stat-3,.stat-4{position:relative;inset:auto;display:flex;width:auto;min-height:124px;padding:18px 12px;justify-content:center;border:0;border-right:1px solid rgba(16,16,15,.16);border-bottom:1px solid rgba(16,16,15,.16);background:transparent}
  .stat:nth-child(2n){border-right:0}
  .stat:nth-last-child(-n+2){border-bottom:0}
  .stat-value{margin-bottom:9px;font-size:clamp(27px,8vw,30px);line-height:1}
  .stat-label{font-size:11px;line-height:1.35;letter-spacing:.06em}

  #about{padding-block:76px;background:#f4f1e9}
  .about-layout{display:grid;grid-template-columns:1fr;gap:36px}
  .about-copy .section-title{max-width:100%;margin:0 0 24px}
  .about-copy p.about-intro{max-width:100%;margin:0;font-size:16px;line-height:1.62}
  .about-copy p.about-audience{max-width:100%;margin:18px 0 0;font-size:16px;line-height:1.6}
  .pillars{display:grid;grid-template-columns:1fr;padding:0;border-top:1px solid rgba(16,16,15,.18)}
  .pillar{display:grid;grid-template-columns:44px minmax(0,1fr);min-height:0;padding:22px 0;gap:16px;align-items:start;border:0;border-bottom:1px solid rgba(16,16,15,.18)}
  .pillar:hover{padding-inline:0;background:transparent}
  .pillar .line-icon{width:42px;height:42px;margin:0}
  .pillar-copy .card-title{margin:1px 0 8px;font-size:16px;line-height:1.15}
  .pillar-copy .card-copy{font-size:14.5px;line-height:1.55}

  .capabilities-section{padding-block:76px}
  .cap-heading .section-title{max-width:100%}
  .cap-grid{display:grid;grid-template-columns:1fr;gap:62px;margin-top:40px}
  .capability{min-height:0;padding:16px 0 0;border-top:2px solid var(--cap-accent);border-bottom:0}
  .cap-image{width:78%;height:220px;margin:10px auto 14px;aspect-ratio:auto}
  .cap-image img{width:100%;max-width:100%;height:100%;object-fit:contain}
  .cap-copy{display:grid;grid-template-columns:38px minmax(0,1fr);gap:8px}
  .capability .eyebrow{font-size:20px}
  .capability .card-title{margin-bottom:10px;font-size:18px;line-height:1.12}
  .capability .card-copy{font-size:15px;line-height:1.55}

  .network-section{padding-block:76px}
  .network-header .card-copy{max-width:100%!important;margin:20px 0 0!important;font-size:16px;line-height:1.62}
  .network-visual{display:grid;grid-template-columns:1fr;gap:24px;margin-top:34px}
  .network-proof{padding:0}
  .network-stat{margin:0 0 10px;font-size:clamp(58px,17vw,68px);line-height:.94}
  .network-label{max-width:280px;font-size:17px;line-height:1.4}
  .network-art-frame{width:100%;margin:0;overflow:visible}
  .network-art{width:100%;max-width:100%;margin:0;transform:none}

  #brands{padding-block:76px}
  .brands-layout{display:grid;grid-template-columns:1fr;gap:30px}
  .brands-copy .section-title{max-width:100%;font-size:clamp(30px,8.8vw,34px);line-height:1.04}
  .brands-copy .card-copy{max-width:100%;margin-top:18px;font-size:16px;line-height:1.62}
  .brand-stage{padding:0;overflow:visible;background:transparent;border:0}
  .carousel{overflow:visible}
  .slides{display:flex;gap:12px;overflow-x:auto;padding:0 22px 6px 0;scroll-snap-type:x mandatory;scroll-padding-left:0;scrollbar-width:none}
  .slides::-webkit-scrollbar{display:none}
  .slide{flex:0 0 min(84vw,360px);scroll-snap-align:start}
  .slide img{width:100%;height:auto;aspect-ratio:.82/1;object-fit:cover}
  .carousel-meta{display:flex;justify-content:flex-start;margin-top:14px;padding:0}
  .carousel-nav{gap:8px}
  .icon-btn{width:44px;height:44px;font-size:18px}
  .dot{width:10px;height:10px}
  .phone-frame{position:relative;inset:auto;width:70%;margin:28px auto 0;filter:drop-shadow(0 18px 26px rgba(0,0,0,.14))}

  .partnership-heading .section-title{max-width:100%}
  .partnerships{display:grid;grid-template-columns:1fr;gap:16px;margin-top:36px}
  .partnership-card,.partnership-card:nth-child(2),.partnership-card:nth-child(3){width:100%;min-height:0;padding:20px;border-width:1px}
  .partnership-card::before{left:20px;width:56px}
  .partnership-card .line-icon{width:42px;height:42px;margin:2px 0 18px}
  .partnership-card .card-title{margin-bottom:10px;font-size:18px;line-height:1.14}
  .partnership-card .card-copy{font-size:14.5px;line-height:1.55}

  .contact-section{min-height:0;padding:0}
  .contact-layout{display:flex;min-height:0;padding:76px 0 0;gap:34px;flex-direction:column;align-items:stretch}
  .contact-copy .section-title{max-width:100%;font-size:clamp(34px,10vw,38px);line-height:1}
  .contact-subcopy{max-width:100%;margin-top:20px;font-size:16px;line-height:1.6}
  .contact-cta{width:min(100%,290px);min-height:52px;margin-top:24px!important}
  .contact-artwork{position:relative;min-height:280px;margin-top:2px;display:flex;align-items:center;justify-content:center}
  .contact-art{position:absolute;inset:50% auto auto 50%;width:100%;max-width:100%;transform:translate(-50%,-48%)}
  .contact-monogram{position:absolute;left:50%;top:50%;width:72px;height:152px;transform:translate(-50%,-55%)}
  .footer{min-height:0;padding:18px 0 24px;font-size:9px;line-height:1.5}

  .whatsapp-float{right:14px;bottom:14px;width:50px;height:50px;padding:0;justify-content:center}
  .whatsapp-label{display:none}
  .whatsapp-status{left:33px;top:5px}
}

@media (max-width:360px){
  .beautimax-shell,.hero-section{padding-inline:20px}
  .nav .beautimax-shell{padding-inline:10px}
  .h1{font-size:36px}
  .hero-actions .btn{min-width:0}
  .market-map-mobile{width:calc(100% + 40px);margin-inline:-20px}
  .cap-image{width:82%;height:200px}
  .slide{flex-basis:84vw}
  .contact-artwork{min-height:250px}
}
