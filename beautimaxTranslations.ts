...
export const translations: Record<Language, SiteTranslation> = {
    ...
    id: {
        ...
        hero: {
            heading: "We build, operate, and grow beauty brands in Indonesia",
            body: "Mulai dari brand baru sampai brand global, kami memudahkan brand kecantikan ditemui oleh konsumen Indonesia.",
        ...
        about: {
            ...
            pillars: [
                { title: "MARKET ENTRY", body: "Kami membantu brand mempersiapkan diri dan meluncur dengan eksekusi lokal yang tepat." },
                ...
                { title: "CHANNEL OPERASIONAL", body: "Kami menangani eksekusi harian di marketplace, retail, dan channel penjualan lainnya." },
        ...
        capabilities: {
            ...
            items: [
                { number: "01", title: "MARKET ENTRY", body: "Membawa brand global agar siap masuk dan tumbuh di pasar lokal.", image: beautimaxAssets.marketEntry, alt: "Visual kesiapan operasional masuk pasar" },
        ...
        network: {
            title: "Jaringan kami dibangun untuk menjangkau semua channel tempat konsumen menemukan produk kecantikan.",
        ...
        partnerships: {
            title: "Kami menyesuaikan kebutuhanmu.",
            cards: [
